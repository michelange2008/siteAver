<?php
namespace App\Factories\PdfFactory\tcpdf;
//============================================================+
// File name   : tcpdf.php
// Version     : 6.2.13
// Begin       : 2002-08-03
 ...
 * @version 6.2.8
 */
use App\Factories\PdfFactory\tcpdf\inclusions\TCPDF_FONT_DATA;
use App\Factories\PdfFactory\tcpdf\inclusions\TCPDF_FONTS;
use App\Factories\PdfFactory\tcpdf\inclusions\TCPDF_COLORS;
use App\Factories\PdfFactory\tcpdf\inclusions\TCPDF_IMAGES;
use App\Factories\PdfFactory\tcpdf\inclusions\TCPDF_STATIC;

// TCPDF configuration
require_once(\dirname(__FILE__).'/tcpdf_autoconfig.php');
// TCPDF static font methods and data
require_once(dirname(__FILE__).'/inclusions/tcpdf_font_data.php');
// TCPDF static font methods and data
require_once(dirname(__FILE__).'/inclusions/tcpdf_fonts.php');
// TCPDF static color methods and data
require_once(dirname(__FILE__).'/inclusions/tcpdf_colors.php');
// TCPDF static image methods and data
require_once(dirname(__FILE__).'/inclusions/tcpdf_images.php');
// TCPDF static methods and data
require_once(dirname(__FILE__).'/inclusions/tcpdf_static.php');
...
class TCPDF {
	 ...
	 */
	protected $cell_height_ratio = 20 ;//K_CELL_HEIGHT_RATIO;
